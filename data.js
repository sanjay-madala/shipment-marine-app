...
const MASTERS = {
    ...
    vessels: [
        ...
        { id: 'V005', name: 'MV EASTERN WAVE', grt: 21000, loa: 185.0, active: false },
    ],
...
let scmTugSchedules = [
    ...
    // ── Additional closed schedules for settlement testing ──
    {
        id: 'TS-006',
        status: 'closed',
        agent: MASTERS.customers[1],
    ...
    },
    {
        ...
        jobType: MASTERS.jobTypes[0],
        scope: 'In-Bay',
        workDate: '2026-03-02T09:00',
        activity: MASTERS.activities[1],
        service: MASTERS.services[2],
        pilot: 'Capt. Somchai',
        bomItems: [
            { ...MASTERS.services[2].items[0], tug: MASTERS.tugBoats[4], wbs: '02S18BK0RS10 0000' },
            { ...MASTERS.services[2].items[1], tug: null, wbs: '' },
        ],
    ...
    },
    {
        ...
        jobType: MASTERS.jobTypes[0],
        scope: 'In-Bay',
        workDate: '2026-03-03T08:00',
        activity: MASTERS.activities[0],
        service: MASTERS.services[0],
        pilot: 'Capt. Suthep',
        bomItems: [
            { ...MASTERS.services[0].items[0], tug: MASTERS.tugBoats[5], wbs: '02S18BK0RS19 0000' },
            { ...MASTERS.services[0].items[1], tug: MASTERS.tugBoats[6], wbs: '02S18BK0RS20 0000' },
            { ...MASTERS.services[0].items[2], tug: null, wbs: '' },
        ],
        createdAt: '2026-03-02T15:30',
    },
];
...
let scmShipments = [
    {
        ...
        reportIns: {
            actual: {
                stages: [
                    { name: 'Start', startTime: '2026-02-27T08:05', endTime: '2026-02-27T08:20', required: true, remark: '' },
                    { name: 'Stand by #1', startTime: '2026-02-27T08:20', endTime: '2026-02-27T08:35', required: false, remark: '' },
                    { name: 'Work Period #1', startTime: '2026-02-27T08:35', endTime: '2026-02-27T09:10', required: false, remark: '' },
                    { name: 'Stand by #2', startTime: 'skipped', endTime: 'skipped', required: false, remark: '' },
                    { name: 'Work Period #2', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '' },
                    { name: 'Stand by #3', startTime: 'skipped', endTime: 'skipped', required: false, remark: '' },
                    { name: 'Work Period #3', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '' },
                    { name: 'Last', startTime: '2026-02-27T10:00', endTime: '2026-02-27T10:00', required: true, remark: '' },
                ],
                confirmedAt: '2026-02-27T10:30',
            },
            billing: {
                stages: [
                    { name: 'Start', startTime: '2026-02-27T08:10', endTime: '2026-02-27T08:25', required: true, remark: '', overrideStart: true, overrideEnd: true },
                    { name: 'Stand by #1', startTime: 'skipped', endTime: 'skipped', required: false, remark: '', overrideStart: false, overrideEnd: false },
                    { name: 'Work Period #1', startTime: '2026-02-27T08:25', endTime: '2026-02-27T09:30', required: false, remark: '', overrideStart: true, overrideEnd: true },
                    { name: 'Stand by #2', startTime: 'skipped', endTime: 'skipped', required: false, remark: '', overrideStart: false, overrideEnd: false },
                    { name: 'Work Period #2', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '', overrideStart: false, overrideEnd: false },
                    { name: 'Stand by #3', startTime: 'skipped', endTime: 'skipped', required: false, remark: '', overrideStart: false, overrideEnd: false },
                    { name: 'Work Period #3', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '', overrideStart: false, overrideEnd: false },
                    { name: 'Last', startTime: '2026-02-27T09:45', endTime: '2026-02-27T09:45', required: true, remark: '', overrideStart: true, overrideEnd: true },
                ],
                confirmedAt: '2026-02-27T10:30',
            },
        },
    },
    {
        ...
        reportIns: {
            actual: {
                stages: [
                    { name: 'Start', startTime: '2026-02-27T08:12', endTime: '2026-02-27T08:22', required: true, remark: '' },
                    { name: 'Stand by #1', startTime: 'skipped', endTime: 'skipped', required: false, remark: '' },
                    { name: 'Work Period #1', startTime: '2026-02-27T08:22', endTime: '2026-02-27T09:25', required: false, remark: '' },
                    { name: 'Stand by #2', startTime: 'skipped', endTime: 'skipped', required: false, remark: '' },
                    { name: 'Work Period #2', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '' },
                    { name: 'Stand by #3', startTime: 'skipped', endTime: 'skipped', required: false, remark: '' },
                    { name: 'Work Period #3', startTime: 'skipped', endTime: 'skipped', required: false, skippable: true, remark: '' },
                    { name: 'Last', startTime: '2026-02-27T09:40', endTime: '2026-02-27T09:40', required: true, remark: '' },
                ],
                confirmedAt: '2026-02-27T10:15',
            },
            billing: {
                stages: [
                    { name: 'Start', startTime: '2026-02-27T08:10', endTime: '2026-02-27T08:25', required: true, remark: '', overrideStart: true, overrideEnd: true },
    ...
    // ── TS-006: Bangkok Shipping / BKK-BAR / Unberth ──
    {
        id: 'SH-1101.26.0005',
        orderId: 'TS-006',
        status: 'closed',
        ...
        tug: MASTERS.tugBoats[2],
        bomItem: { ...MASTERS.services[1].items[0], wbs: '02S18BK0RS7  0000' },
        reportIns: _mkRI('2026-02-28T14:05', '2026-02-28T14:05', '2026-02-28T16:25',
    ...
    },
    {
        ...
        tug: MASTERS.tugBoats[3],
        bomItem: { ...MASTERS.services[1].items[1], wbs: '02S18BK0RS9  0000' },
        reportIns: _mkRI('2026-02-28T14:08', '2026-02-28T14:08', '2026-02-28T16:20',
                         '2026-02-28T14:00', '2026-02-28T14:00', '2026-02-28T16:30'),
    },
    // ── TS-007: Siam Ocean / MIT / Berth ──
    {
        id: 'SH-1101.26.0007',
        orderId: 'TS-007',
        status: 'closed',
        ...
        bomItem: { ...MASTERS.services[0].items[0], wbs: '02S18MT0K101 0000' },
        reportIns: _mkRI('2026-03-01T06:03', '2026-03-01T06:03', '2026-03-01T07:55',
    ...
    },
    {
        ...
        bomItem: { ...MASTERS.services[0].items[1], wbs: '02S18MT0K102 0000' },
        reportIns: _mkRI('2026-03-01T06:05', '2026-03-01T06:05', '2026-03-01T07:58',
                         '2026-03-01T06:00', '2026-03-01T06:00', '2026-03-01T08:00'),
    },
    // ── TS-008: Thai Maritime / BKK-MID / Shifting ──
    {
        id: 'SH-1101.26.0009',
        orderId: 'TS-008',
        status: 'closed',
        ...
        bomItem: { ...MASTERS.services[2].items[0], wbs: '02S18BK0RS10 0000' },
        reportIns: _mkRI('2026-03-02T09:02', '2026-03-02T09:02', '2026-03-02T10:28',
                         '2026-03-02T09:00', '2026-03-02T09:00', '2026-03-02T10:30'),
    },
    // ── TS-009: Gulf Navigation / BLCP / Berth ──
    {
        id: 'SH-1101.26.0010',
        orderId: 'TS-009',
        status: 'closed',
        ...
        bomItem: { ...MASTERS.services[0].items[0], wbs: '02S18MT0K201 0000' },
        reportIns: _mkRI('2026-03-02T14:04', '2026-03-02T14:04', '2026-03-02T16:58',
                         '2026-03-02T14:00', '2026-03-02T14:00', '2026-03-02T17:00'),
    },
    {
        id: 'SH-1101.26.0011',
        orderId: 'TS-009',
        ...
        bomItem: { ...MASTERS.services[0].items[1], wbs: '02S18MT0K301 0000' },
        reportIns: _mkRI('2026-03-02T14:06', '2026-03-02T14:06', '2026-03-02T16:55',
                         '2026-03-02T14:00', '2026-03-02T14:00', '2026-03-02T17:00'),
    },
    // ── TS-010: Bangkok Shipping / BKK-TUG / Berth ──
    {
        id: 'SH-1101.26.0012',
        orderId: 'TS-010',
        status: 'closed',
        ...
        bomItem: { ...MASTERS.services[0].items[0], wbs: '02S18BK0RS19 0000' },
        reportIns: _mkRI('2026-03-03T08:03', '2026-03-03T08:03', '2026-03-03T09:42',
                         '2026-03-03T08:00', '2026-03-03T08:00', '2026-03-03T09:45'),
    },
    {
        id: 'SH-1101.26.0013',
        orderId: 'TS-010',
        ...
        bomItem: { ...MASTERS.services[0].items[1], wbs: '02S18BK0RS20 0000' },
        reportIns: _mkRI('2026-03-03T08:05', '2026-03-03T08:05', '2026-03-03T09:40',
                         '2026-03-03T08:00', '2026-03-03T08:00', '2026-03-03T09:45'),
    },
];
...
function makeEmptyStages() {
    return [
        { name: 'Start', startTime: '', endTime: '', required: true, remark: '' },
        { name: 'Stand by #1', startTime: '', endTime: '', required: false, remark: '' },
        { name: 'Work Period #1', startTime: '', endTime: '', required: false, remark: '' },
        { name: 'Stand by #2', startTime: '', endTime: '', required: false, remark: '' },
        { name: 'Work Period #2', startTime: '', endTime: '', required: false, skippable: true, remark: '' },
        { name: 'Stand by #3', startTime: '', endTime: '', required: false, remark: '' },
        { name: 'Work Period #3', startTime: '', endTime: '', required: false, skippable: true, remark: '' },
        { name: 'Last', startTime: '', endTime: '', required: true, remark: '' },
    ];
}
