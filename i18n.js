...
const TRANSLATIONS = {
    en: {
        ...
        bothReportsRequired: 'Actual report must be completed before review.',
        actualReport: 'Actual Report',
        billingReport: 'Billing Report',
        customerReport: 'Actual Report',
        internalReport: 'Billing Report',
        reportNotStarted: 'Not started yet',
        startCustomerReport: 'Start Report-In',
        startInternalReport: 'Start Report-In',
        actualReportComplete: 'Actual report completed',
        billingReportComplete: 'Billing report synced',
        customerReportComplete: 'Actual report completed',
        internalReportComplete: 'Billing report synced',
        ...
        settlementReports: 'Reports',
        salesOrders: 'Sales Orders',
        createSettlementReport: 'Create Settlement Report',
        pendingSO: 'Pending SO',
        pendingSAP: 'Pending SAP',
        soPosted: 'SO Posted',
        postToSAP: 'Post to SAP',
        billingHrs: 'Billing Hrs',
        actualHrs: 'Actual Hrs',
        rate: 'Rate (THB)',
        amount: 'Amount (THB)',
        createSalesOrder: 'Create Sales Order',
        noAwaitingSettlement: 'No shipments awaiting settlement',
        noSettlementReports: 'No settlement reports yet',
    ...
    th: {
        // Header
        appName: 'Marine Shipment',
        scmModule: 'SCM - Tug Boat',
        npmModule: 'NPM',
        admin: 'Admin',
        ...
        salesOrder: 'Sales Order',
        vesselShipment: 'Vessel Shipment',
        containerNotReturning: 'ตู้ไม่กลับมาที่ท่าเรือ',
        containerNotClosed: 'ตู้ยังไม่ปิดงาน',
        ...
        cancelEirIn: 'Cancel EIR In',
        driverLicenseNo: 'Driver License No.',
        bothReportsRequired: 'ต้องบันทึก Actual Report ให้ครบก่อนตรวจสอบ',
        actualReport: 'Actual Report',
        billingReport: 'Billing Report',
        customerReport: 'Actual Report',
        internalReport: 'Billing Report',
        reportNotStarted: 'ยังไม่เริ่ม',
        startCustomerReport: 'เริ่มรายงาน',
        startInternalReport: 'เริ่มรายงาน',
        actualReportComplete: 'Actual Report เสร็จสิ้น',
        billingReportComplete: 'Billing Report sync แล้ว',
        customerReportComplete: 'Actual Report เสร็จสิ้น',
        internalReportComplete: 'Billing Report sync แล้ว',
        autoFilledFromPrevious: 'เติมอัตโนมัติจากขั้นตอนก่อน',

        // SCM - Settlement
        settlement: 'Settlement',
        settlementTitle: 'Settlement',
        awaitingSettlement: 'รอ Settlement',
        settlementReports: 'รายงาน',
        salesOrders: 'Sales Orders',
        createSettlementReport: 'สร้าง Settlement Report',
        pendingSO: 'รอ SO',
        pendingSAP: 'รอ SAP',
        soPosted: 'ส่ง SAP แล้ว',
        postToSAP: 'ส่งไป SAP',
        billingHrs: 'Billing Hrs',
        actualHrs: 'Actual Hrs',
        rate: 'Rate (THB)',
        amount: 'Amount (THB)',
        createSalesOrder: 'สร้าง Sales Order',
        noAwaitingSettlement: 'ไม่มีรายการรอ Settlement',
        noSettlementReports: 'ยังไม่มี Settlement Report',
        noSalesOrders: 'ยังไม่มี Sales Order',
...
function setLang(lang) {
    ...
    // Update sidebar labels (target .nav-label to preserve SVG icons)
