...
const TRANSLATIONS = {
    ...
    th: {
        ...
        // EIR - Header
        event: 'เหตุการณ์',
        checkInOnly: 'เช็คอินเท่านั้น',
        checkOutOnly: 'เช็คเอาท์เท่านั้น',
        gateIn: 'ประตูเข้า',
        gateOut: 'ประตูออก',
        fiscalYear: 'ปีงบประมาณ',
        eirNo: 'เลขที่ EIR',
        salesOrder: 'ใบสั่งขาย',
        vesselShipment: 'การจัดส่งเรือ',
        ...
        lineAgent: 'สายเรือ / ตัวแทน',
        containerStatus: 'สถานะ (FCL/LCL)',
        fcl: 'FCL',
        lcl: 'LCL',
        forwarder: 'ผู้ส่งของ',
        customerCode: 'ลูกค้า',
        sVesselVoy: 'เรือ/เที่ยวเรือ S',
        commodity: 'สินค้า',
        stuffingAt: 'สถานที่บรรจุ',
        // EIR - Truck Detail
        truckDetail: 'รายละเอียดรถบรรทุก',
        shipmentNoItem: 'เลขที่จัดส่ง',
        itemNo: 'รายการ',
        ...
        editContainer: 'แก้ไขตู้คอนเทนเนอร์',
        bookingSaved: 'บันทึกการจองแล้ว',
        containerSaved: 'บันทึกตู้คอนเทนเนอร์แล้ว',
        revalidate: 'ตรวจสอบอีกครั้ง',
        revalidating: 'กำลังตรวจสอบตู้คอนเทนเนอร์...',
        revalidateSuccess: 'ตรวจสอบเสร็จสิ้น ตรงกัน {matched} รายการ, ไม่ตรงกัน {mismatched} รายการ',
        allContainersMatched: 'ตู้คอนเทนเนอร์ทั้งหมดตรงกับการจอง!',
        cancelEirOut: 'ยกเลิก EIR ออก',
        cancelEirIn: 'ยกเลิก EIR เข้า',
        driverLicenseNo: 'เลขที่ใบขับขี่',
